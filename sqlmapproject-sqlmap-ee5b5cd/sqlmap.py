...
def main():
    ...
    try:
        checkEnvironment()
        setPaths(modulePath())
        banner() #this function print sqlmap banner with its version
        ...
        if conf.profile:
            ...
            try:
                start() #This function calls a function that performs checks on both URL stability and all GET,POST,Cookie and User-Agent parameters to check if they are dynamic and SQL injection affected
