...
def initTargetEnv():
    ...
    if conf.multipleTargets:
        ...
        _setKnowledgeBaseAttributes(False) #This function set some attributes into the knowledge base singleton
        _restoreMergedOptions() #Restore merged option that could be possibly changed during the testing of previous target.
        _setDBMS()  #force the back-end DBMS option.
